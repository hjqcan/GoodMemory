...
- `plans/GoodMemory-v0.7.3-Replacement-Protection-Protocol.md` - schema-4
  ...
  provider-variance boundary; schema-2, schema-3, and the single schema-4
  attempt remain blocked, and no passing run or release is implied.
