...
This is the canonical global CLI `0.7.3` Codex release-candidate setup path.
The registry command applies after publication; before publication use the
local tarball path below.
