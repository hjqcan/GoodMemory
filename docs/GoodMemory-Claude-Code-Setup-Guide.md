...
This is the canonical global CLI `0.7.5` Claude Code setup path. The registry
...
```bash
npm install -g ./goodmemory-0.7.5.tgz
goodmemory -V
```
...
Bun services can install the same package with `bun add goodmemory@0.7.5`.
