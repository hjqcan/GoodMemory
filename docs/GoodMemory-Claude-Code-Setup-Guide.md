...
This is the canonical global CLI `0.7.2` Claude Code installed-host setup path.
...
```bash
npm install -g ./goodmemory-0.7.2.tgz
goodmemory -V
```
...
Bun services can install the same package with `bun add goodmemory@0.7.2`.
