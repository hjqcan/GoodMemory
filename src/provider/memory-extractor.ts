...
export function buildConversationalMemoryExtractionPrompt(
  ...
  const rules = [
    ...
    "- From assistant messages, extract concrete contributions establishing shared state: recommendations, decisions, commitments, and named artifacts; skip generic advice and exposition.",
