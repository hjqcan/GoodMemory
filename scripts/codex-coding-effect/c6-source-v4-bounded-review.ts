...
const requiredChecksSchema = z.tuple([
  ...
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[8]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[9]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[10]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[11]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[12]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[13]),
  z.literal(C6_SOURCE_V4_BOUNDED_REVIEW_REQUIRED_CHECKS[14]),
]);
